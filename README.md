...
- UofT-themed landing page
- Light and dark mode
- Countdown to the first day of the workshop
- Student login 
...
| Page              | What it's for                                   |
|-------------------|-------------------------------------------------|
| `index.html`      | Landing page: about, schedule, and prizes       |
| `login.html`      | Student login                                   |
| `dashboard.html`  | Logged-in student view with day-by-day content  |
| `instructor.html` | Placeholder for a future instructor tool        |
...
This is an early front-end prototype: there's no server behind it. I'm not sure if I will publish the full code here. 
